...
window.CG_NEWS = {
  months: [
    { key:"2026-09", label:"September 2026", items:[
      {"nat":"site","uni":"avatar","kind":"timeline","title":"Avatar Legends: two orders","txt":"The page now reads two ways — on a first watch, the Yangchen, Kyoshi and Roku eras become flashbacks placed after the Aang era; on a rewatch, everything goes back to its own date.","href":"en-avatar.html","cta":"Open the timeline"},
      {"nat":"media","uni":"avatar","kind":"comic","title":"Jet: Rebels and Rhinos","meta":"~95 AG","vo":true,"txt":"Added to the Avatar Legends timeline, in ~95 AG, just after Season 2 Episode 17 of The Last Airbender.","href":"en-avatar.html#avt-jet-rebels-and-rhinos","cta":"See in the timeline"},
    ...
    { key:"2026-08", label:"August 2026", items:[
      {"nat":"media","uni":"sw","kind":"jeu","title":"Star Wars Zero Company","meta":"19 BBY","txt":"Added to the Star Wars timeline, in 19 BBY, just after The Clone Wars Season 7 Episodes 9-12.","img":"/images/zerocompany.webp","href":"en-starwars.html#sw-zerocompany","cta":"See in the timeline"},
