...
const DATA_SW={
  ...
  eras:[
    {title:"L'ÈRE DE LA RÉPUBLIQUE",entries:[
      ...
      {id:"sw-ep2",type:"film",level:"must",tmdb:"1894",media:"movie",img:"/images/starwars2.webp",title:"Épisode II : L'Attaque des Clones",date:"22 BBY",faq:{quand:"Le film se déroule 10 ans après l'Épisode I",pourquoi:"Parce qu'il se situe ici chronologiquement"}},
      {id:"sw-toj2",type:"anime",level:"important",tmdb:"203085",media:"tv",img:"/images/talesofthejedi.webp",title:"Tales of the Jedi — Épisode 2",date:"~60 BBY",tags:["flashback"],faq:{quand:"L'épisode se déroule environ 30 ans avant La Menace Fantôme",pourquoi:"Parce qu'il vaut mieux déjà connaître les personnages et voir cette histoire sous forme de flashback pour mieux comprendre"}},
      {id:"sw-toj3",type:"anime",level:"important",tmdb:"203085",media:"tv",img:"/images/talesofthejedi.webp",title:"Tales of the Jedi — Épisode 3",date:"~50 BBY",tags:["flashback"],faq:{quand:"L'épisode se déroule environ 10 ans après l'épisode précédent",pourquoi:"Parce qu'il vaut mieux déjà connaître les personnages et voir cette histoire sous forme de flashback pour mieux comprendre"}},
    ...
    {title:"LA GUERRE DES CLONES",entries:[
      ...
      {id:"sw-toe4",type:"anime",level:"important",tmdb:"251091",media:"tv",img:"/images/talesofthempire.webp",title:"Tales of the Empire — Épisode 4",date:"19 BBY",note:"Pendant La Revanche des Sith",faq:{quand:"L'épisode se déroule en parallèle des évènements de La Revanche des Sith",pourquoi:"Parce que l'épisode spoile le film"}},
    ...
    {title:"L'ÈRE DE L'EMPIRE",entries:[
      ...
      {id:"sw-toj6",type:"anime",level:"important",tmdb:"203085",media:"tv",img:"/images/talesofthejedi.webp",title:"Tales of the Jedi — Épisode 6",date:"~16–15 BBY",note:"Prologue pendant La Revanche des Sith",faq:{quand:"L'épisode débute pendant La Revanche des Sith et se déroule ensuite dans une période indéterminée entre 16 et 14 BBY",pourquoi:"Parce qu'il se situe ici chronologiquement"}},
      {id:"sw-fo",type:"jeu",level:"bonus",tmdb:"0",media:"game",img:"/images/fallenorder.webp",title:"Star Wars Jedi : Fallen Order",date:"14 BBY",faq:{quand:"Le jeu se déroule en 14 BBY, 5 ans après l'Épisode III",play:"Parce qu'il se situe ici chronologiquement"},desc:"Jeu développé par Respawn Entertainment, Jedi Fallen Order installe son intrigue entre le troisième et le quatrième volet de la saga. Le joueur incarne un jeune Padawan cherchant à fuir l\'Empire et la traque des derniers Jedi encore en vie, une chasse à l\'homme menée par Darth Vader."},
      {id:"sw-zerocompany",type:"jeu",level:"bonus",tmdb:"0",media:"game",img:"/images/zerocompany.webp",title:"Star Wars Zero Company",date:"19-18 BBY",tags:["flashback"],faq:{quand:"Le jeu se déroule en 19-18 BBY, avant, pendant et après La Revanche des Sith",play:"Parce qu'il spoile des éléments de différents médias qui viennent avant"},desc:"Star Wars Zero Company est un jeu de tactique au tour par tour développé par Bit Reactor avec Respawn Entertainment et Lucasfilm Games. Il se déroule dans les derniers temps de la Guerre des Clones, où un ancien officier de la République rassemble une escouade de combattants venus de tous les horizons."},
      {id:"sw-solo",type:"film",level:"bonus",tmdb:"348350",media:"movie",img:"/images/solo.webp",title:"Solo : A Star Wars Story",date:"10 BBY",faq:{quand:"Le film se déroule en majorité en 10 BBY",pourquoi:"Parce qu'il se situe ici chronologiquement"}},
      {id:"sw-kenobi",type:"serie",level:"important",tmdb:"92830",media:"tv",img:"/images/kenobi.webp",title:"Obi-Wan Kenobi",date:"9 BBY",faq:{quand:"La série se déroule en 9 BBY",pourquoi:"Parce qu'elle se situe ici chronologiquement"}},
      {id:"sw-toe6",type:"anime",level:"important",tmdb:"251091",media:"tv",img:"/images/talesofthempire.webp",title:"Tales of the Empire — Épisode 6",date:"~9–6 BBY",faq:{quand:"On ne sait pas exactement quand se déroule l'épisode mais probablement à suite de la série Obi-Wan Kenobi, dans les mois ou années qui suivent",pourquoi:"Parce que l'épisode inclut un personnage de Obi-Wan Kenobi et marche bien à la suite directe"}},
      {id:"sw-survivor",type:"jeu",level:"bonus",tmdb:"0",media:"game",img:"/images/survivor.webp",title:"Star Wars Jedi : Survivor",date:"9 BBY",faq:{quand:"Le jeu se déroule 5 ans après Fallen Order",play:"Parce que le jeu fonctionne mieux après les évènements de Obi-Wan Kenobi"},desc:"Star Wars Jedi : Survivor se passe cinq années après Fallen Order et plonge le joueur une nouvelle fois dans l\'histoire de Cal Kestis. Notre héros est désormais un Jedi accompli et tente de survivre aux confins de la Galaxie. Toujours accompagné de BD-1, le Jedi affrontera à nouveau le terrible Empire galactique."}
    ]},
    {title:"L'ÈRE DE LA RÉBELLION",entries:[
      ...
      {id:"sw-outlaws",type:"jeu",level:"bonus",tmdb:"0",media:"game",img:"/images/outlaws.avif",title:"Star Wars Outlaws + DLC Wild Card + DLC A Pirate's Fortune",date:"3 ABY",faq:{quand:"Le jeu se déroule pendant l'an séparant l'Épisode V de l'Épisode VI en 3 ABY",play:"Parce qu'il se situe ici chronologiquement"},desc:"Star Wars Outlaws est un jeu vidéo développé par Massive Entertainment, édité par Ubisoft et sous licence LucasFilm. C\'est un titre d\'aventure en monde ouvert prenant place dans l\'univers de Star Wars et plus précisément entre les films l\'Empire Contre-Attaque et le Retour du Jedi."},
      {id:"sw-ep6",type:"film",level:"must",tmdb:"1892",media:"movie",img:"/images/starwars6.webp",title:"Épisode VI : Le Retour du Jedi",date:"4 ABY",faq:{quand:"Le film se déroule 1 an après L'Empire Contre-Attaque en 4 ABY",pourquoi:"Parce qu'il se situe ici chronologiquement"}},
      {id:"sw-bf2-prologue",type:"jeu",level:"important",tmdb:"0",media:"game",img:"/images/battlefront.webp",title:"Star Wars Battlefront II Prologue : The Cleaner",date:"4 ABY",tags:["flashback"],faq:{quand:"Le prologue du jeu se déroule juste avant les événements du Retour du Jedi",play:"Parce que bien que servant d'introduction au jeu et se déroulant avant, il est mieux de jouer le Prologue puis le reste des missions sans faire une pause pour regarder un film"},desc:"Star Wars Battlefront II est un FPS se déroulant dans l\'univers de la saga à succès. Le titre vous permet de prendre part à des combats sur Terre ou dans les airs dans les lieux emblématiques des films. Rejoignez les rangs de l\'Empire ou ceux de la Rébellion dans des parties multijoueur endiablées et profitez d\'une expérience solo inédite aux commandes d\'un soldat de l\'Empire."},
      {id:"sw-bf2-c1",type:"jeu",level:"important",tmdb:"0",media:"game",img:"/images/battlefront.webp",title:"Star Wars Battlefront II Campagne : Missions 1-6",date:"4 ABY",faq:{quand:"Les 6 premières missions se déroulent juste après Le Retour du Jedi en 4 ABY",play:"Parce qu'il se situe ici chronologiquement"},desc:"Star Wars Battlefront II est un FPS se déroulant dans l\'univers de la saga à succès. Le titre vous permet de prendre part à des combats sur Terre ou dans les airs dans les lieux emblématiques des films. Rejoignez les rangs de l\'Empire ou ceux de la Rébellion dans des parties multijoueur endiablées et profitez d\'une expérience solo inédite aux commandes d\'un soldat de l\'Empire."},
      {id:"sw-squadrons",type:"jeu",level:"bonus",tmdb:"0",media:"game",img:"/images/squadrons.webp",title:"Star Wars Squadrons",date:"4 ABY",faq:{quand:"Le prologue se déroule pendant l'Épisode IV et la suite du jeu se passe en parallèle des évènements de Battlefront II",play:"Parce que les 2 jeux se passent à peu près en même temps et que la suite de Battlefront II fait un bond dans le temps d'un an donc autant faire celui-là ici"},desc:"Star Wars : Squadrons est un jeu de combat spatial à la première personne. Vous incarnerez un pilote, et devrez contrôler les vaisseaux les plus emblématiques de la licence. Le jeu se déroule après les événement de l\'épisode VI de la saga, Le Retour du Jedi. Il propose un mode histoire mais aussi un mode multi en 5c5."},
      {id:"sw-bf2-c2",type:"jeu",level:"important",tmdb:"0",media:"game",img:"/images/battlefront.webp",title:"Star Wars Battlefront II Campagne : Missions 7-11",date:"5 ABY",faq:{quand:"La suite du jeu se déroule une année après les précédentes missions",play:"Parce qu'il se situe ici chronologiquement"},desc:"Star Wars Battlefront II est un FPS se déroulant dans l\'univers de la saga à succès. Le titre vous permet de prendre part à des combats sur Terre ou dans les airs dans les lieux emblématiques des films. Rejoignez les rangs de l\'Empire ou ceux de la Rébellion dans des parties multijoueur endiablées et profitez d\'une expérience solo inédite aux commandes d\'un soldat de l\'Empire."}
    ]},
    {title:"L'ÈRE DE LA NOUVELLE RÉPUBLIQUE",entries:[
      ...
      {id:"sw-skelcrew",type:"serie",level:"bonus",tmdb:"202879",media:"tv",img:"/images/skeletoncrew.webp",title:"Skeleton Crew",date:"~9 ABY",faq:{quand:"La série se déroule probablement au même moment que les autres de cette période en 9 ABY",pourquoi:"Parce qu'elle se situe ici chronologiquement"}}
    ]},
    {title:"L'ÈRE DU PREMIER ORDRE",entries:[
      {id:"sw-ep7",type:"film",level:"must",tmdb:"140607",media:"movie",img:"/images/starwars7.webp",title:"Épisode VII : Le Réveil de la Force",date:"34 ABY",faq:{quand:"Le film se déroule en 34 ABY",pourquoi:"Parce qu'il se situe ici chronologiquement"}},
      {id:"sw-bf2-m12",type:"jeu",level:"important",tmdb:"0",media:"game",img:"/images/battlefront.webp",title:"Star Wars Battlefront II Campagne : Mission 12",date:"~34 ABY",tags:["flashback"],faq:{quand:"La mission se déroule peu de temps avant l'Épisode VII",play:"Parce qu'il vaut mieux découvrir d'abord les personnages dans le film"},desc:"Star Wars Battlefront II est un FPS se déroulant dans l\'univers de la saga à succès. Le titre vous permet de prendre part à des combats sur Terre ou dans les airs dans les lieux emblématiques des films. Rejoignez les rangs de l\'Empire ou ceux de la Rébellion dans des parties multijoueur endiablées et profitez d\'une expérience solo inédite aux commandes d\'un soldat de l\'Empire."},
      {id:"sw-bf2res",type:"jeu",level:"important",tmdb:"0",media:"game",img:"/images/battlefront.webp",title:"Star Wars Battlefront II Campagne : Résurrection",date:"34 ABY",faq:{quand:"Les 3 missions se déroulent avant, pendant et après Le Réveil de la Force",play:"Parce que c'est un bon compagnon au film précédent et une bonne introduction au film suivant"},desc:"Star Wars Battlefront II est un FPS se déroulant dans l\'univers de la saga à succès. Le titre vous permet de prendre part à des combats sur Terre ou dans les airs dans les lieux emblématiques des films. Rejoignez les rangs de l\'Empire ou ceux de la Rébellion dans des parties multijoueur endiablées et profitez d\'une expérience solo inédite aux commandes d\'un soldat de l\'Empire."},
  ...
  erasRewatch:[
    ...
    {title:"L'ÈRE DE L'EMPIRE",entries:[
      {ref:"sw-bb1"},
      {ref:"sw-bb2"},
      {ref:"sw-zerocompany",faq:{play:"Parce qu'il couvre une période assez longue et qu'il se place bien ici, sans aucun spoil"}},
      {ref:"sw-totu1"},
      {ref:"sw-totu23"},
      {ref:"sw-maul"},
      {ref:"sw-toj6"},
    ...
    {title:"L'ÈRE DU PREMIER ORDRE",entries:[
      {ref:"sw-bf2-m12",drop:["tags","faq.play"]},
      {ref:"sw-ep7"},
      {ref:"sw-bf2res"},
      {ref:"sw-ep8"},
      {ref:"sw-ep9"}
  ...
  erasRelease:[
    {title:"LA TRILOGIE ORIGINALE",entries:[
    ...
    {title:"L’ÈRE THE CLONE WARS",entries:[
      {ref:"sw-tcwfilm",date:"2008",drop:["tags","faq.pourquoi","faq.play"]},
      {ref:"sw-tcw-pre",date:"2008-2020",note:"La série a diffusé de 2008 à 2020, et ses arcs ne sortent pas dans l’ordre où on les regarde : le bloc garde donc l’ordre du guide. Les épisodes regroupés ci-dessous sont des arcs narratifs, séparés par des lignes vides",drop:["tags","faq.pourquoi","faq.play"]},
    ...
    {title:"LE RACHAT PAR DISNEY",entries:[
    ...
    {title:"L’ÈRE DU STREAMING",entries:[
    ...
    {title:"LA DERNIÈRE VAGUE",entries:[
