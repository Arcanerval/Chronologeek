...
export const AC_TRADUCTIONS = [
  ...
  ['The novel portrays Élise de la Serre\'s perspective of the events from the game of the same name and Arno Dorian\'s experiences after the game.',
    'Le roman raconte les événements du jeu du même nom du point de vue d\'Élise de la Serre, puis ce que devient Arno Dorian après la fin du jeu.'],
