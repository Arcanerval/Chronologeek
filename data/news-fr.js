  ...
  months: [
    ...
    { key:"2026-09", label:"Septembre 2026", items:[
      ...
      { nat:"site", uni:"residentevil", kind:"timeline",
        ...
        href:"/fr/residentevil", cta:"Ouvrir la timeline" },
      ...
      { nat:"site", uni:"jurassic", kind:"timeline",
        ...
        href:"/fr/jurassicworld", cta:"Ouvrir la timeline" },
      ...
      { nat:"media", uni:"sw", kind:"jeunesse",
        ...
        href:"/fr/dossiers/star-wars#0-4-aby-hiding-from-the-dark",
        cta:"Voir dans le Dossier" }
    ...
    { key:"2026-08", label:"Août 2026", items:[
      ...
      { nat:"media", uni:"sw", kind:"jeu",
        ...
        href:"/fr/starwars#sw-zerocompany",
        cta:"Voir dans la timeline" },
      ...
      { nat:"site", uni:"twd", kind:"timeline",
        ...
        href:"/fr/walkingdead", cta:"Ouvrir la timeline" },
      ...
      { nat:"media", uni:"sw", kind:"comic",
        ...
        txt:"Ajouté au Dossier Star Wars — le comic, en 34 ABY, juste après "+
            "L'Héritage de Vador.",
        href:"/fr/dossiers/star-wars#34-aby-the-fall-of-kylo-ren-1-5",
        cta:"Voir dans le Dossier" },
